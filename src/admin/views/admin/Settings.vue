            ...
            <div class="w-full lg:w-9/12 px-4">
              <div class="flex gap-4">
                ...
                <button
                  ...
                  @click="resetForm"
                  :disabled="isSubmitting"
                  class="bg-blueGray-500 text-white active:bg-blueGray-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none ease-linear transition-all duration-150"
                  :class="{ 'opacity-50 cursor-not-allowed': isSubmitting }"
                >
